		...
		int                     size)
{
	...
	if (snowglobeGetRenderWaves (s) && snowglobeGetShowWater (s) &&
	    !snowglobeGetWaveRipple (s))
	...
	drawWater(as->water, snowglobeGetShowWater(s), drawDeformation);
    }
		...
		int        ms)
{
    ...
    /* temporary change for snow inside */
